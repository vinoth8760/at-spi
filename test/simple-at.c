...
static boolean report_command_key_event  (AccessibleKeystroke *stroke, void *user_data);
static boolean report_ordinary_key_event (AccessibleKeystroke *stroke, void *user_data);
...
static void 
_festival_say (const char *text, const char *voice, boolean shutup)
{
  static int fd = 0;
  gchar *quoted;
  gchar *p;
